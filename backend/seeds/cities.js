...
const parkingData = [
  ...
  {
    location: "Vesu, Surat",
    name: "Vesu Heights Parking",
    rate: 30,
    totalSlots: 15,
    availableSlots: 15,
    openTime: "09:00",
    closeTime: "23:00",
    geometry: { type: "Point", coordinates: [72.7722, 21.1412] }
  },
  {
    location: "Piplod, Surat",
    name: "Piplod Mall Parking",
    rate: 40,
    totalSlots: 20,
    availableSlots: 20,
    openTime: "10:00",
    closeTime: "22:00",
    geometry: { type: "Point", coordinates: [72.7805, 21.1590] }
  },
  {
    location: "Citylight, Surat",
    name: "Citylight Avenue Parking",
    rate: 35,
    totalSlots: 10,
    availableSlots: 10,
    openTime: "07:00",
    closeTime: "23:00",
    geometry: { type: "Point", coordinates: [72.7981, 21.1689] }
  },
  {
    location: "Athwa, Surat",
    name: "Athwa Lines Parking",
    rate: 28,
    totalSlots: 18,
    availableSlots: 18,
    openTime: "06:00",
    closeTime: "22:30",
    geometry: { type: "Point", coordinates: [72.8078, 21.1844] }
  },
  {
    location: "Althan, Surat",
    name: "Althan Main Road Parking",
    rate: 22,
    totalSlots: 14,
    availableSlots: 14,
    openTime: "08:00",
    closeTime: "21:00",
    geometry: { type: "Point", coordinates: [72.8231, 21.1745] }
  },
  {
    location: "Udhna, Surat",
    name: "Udhna Textile Market Parking",
    rate: 18,
    totalSlots: 25,
    availableSlots: 25,
    openTime: "05:00",
    closeTime: "20:00",
    geometry: { type: "Point", coordinates: [72.8529, 21.1750] }
  },
  {
    location: "Katargam, Surat",
    name: "Katargam Industrial Parking",
    rate: 20,
    totalSlots: 30,
    availableSlots: 30,
    openTime: "06:00",
    closeTime: "22:00",
    geometry: { type: "Point", coordinates: [72.8652, 21.2308] }
  },
  {
    location: "Varachha, Surat",
    name: "Varachha Diamond Hub Parking",
    rate: 24,
    totalSlots: 16,
    availableSlots: 16,
    openTime: "07:00",
    closeTime: "23:00",
    geometry: { type: "Point", coordinates: [72.8865, 21.2232] }
  },
  {
    location: "Pal, Surat",
    name: "Pal Riverside Parking",
    rate: 30,
    totalSlots: 10,
    availableSlots: 10,
    openTime: "08:00",
    closeTime: "22:00",
    geometry: { type: "Point", coordinates: [72.7687, 21.1948] }
  },
  {
    location: "Bhatar, Surat",
    name: "Bhatar Circle Parking",
    rate: 20,
    totalSlots: 12,
    availableSlots: 12,
    openTime: "07:30",
    closeTime: "22:00",
    geometry: { type: "Point", coordinates: [72.8012, 21.1720] }
  },
  {
    location: "Parle Point, Surat",
    name: "Parle Point Corner Parking",
    rate: 25,
    totalSlots: 15,
    availableSlots: 15,
    openTime: "06:30",
    closeTime: "21:30",
    geometry: { type: "Point", coordinates: [72.8009, 21.1654] }
  },
  {
    location: "Dumas, Surat",
    name: "Dumas Beach Parking",
    rate: 50,
    totalSlots: 40,
    availableSlots: 40,
    openTime: "05:00",
    closeTime: "00:00",
    geometry: { type: "Point", coordinates: [72.7008, 21.0631] }
  },
  {
    location: "Magdalla, Surat",
    name: "Magdalla Port Parking",
    rate: 35,
    totalSlots: 18,
    availableSlots: 18,
    openTime: "06:00",
    closeTime: "21:00",
    geometry: { type: "Point", coordinates: [72.7880, 21.1361] }
  },
  {
    location: "Rander, Surat",
    name: "Rander Heritage Parking",
    rate: 23,
    totalSlots: 12,
    availableSlots: 12,
    openTime: "08:00",
    closeTime: "21:00",
    geometry: { type: "Point", coordinates: [72.8000, 21.2212] }
  },
  {
    location: "Nanpura, Surat",
    name: "Nanpura Core Parking",
    rate: 27,
    totalSlots: 14,
    availableSlots: 14,
    openTime: "07:00",
    closeTime: "22:30",
    geometry: { type: "Point", coordinates: [72.8222, 21.1902] }
  },
  {
    location: "Sachin GIDC, Surat",
    name: "Sachin Industrial Parking",
    rate: 18,
    totalSlots: 20,
    availableSlots: 20,
    openTime: "06:00",
    closeTime: "20:00",
    geometry: { type: "Point", coordinates: [72.8822, 21.0917] }
  },
  {
    location: "Hazira, Surat",
    name: "Hazira Port Terminal Parking",
    rate: 45,
    totalSlots: 25,
    availableSlots: 25,
    openTime: "07:00",
    closeTime: "23:00",
    geometry: { type: "Point", coordinates: [72.6277, 21.1168] }
  },
  {
    location: "Bamroli, Surat",
    name: "Bamroli Junction Parking",
    rate: 22,
    totalSlots: 13,
    availableSlots: 13,
    openTime: "08:00",
    closeTime: "21:00",
    geometry: { type: "Point", coordinates: [72.8430, 21.1542] }
  },
  {
    location: "Kosad, Surat",
    name: "Kosad Railway Parking",
    rate: 19,
    totalSlots: 17,
    availableSlots: 17,
    openTime: "07:00",
    closeTime: "20:00",
    geometry: { type: "Point", coordinates: [72.8691, 21.2448] }
  },
  {
    location: "Amroli, Surat",
    name: "Amroli Central Parking",
    rate: 21,
    totalSlots: 15,
    availableSlots: 15,
    openTime: "06:00",
    closeTime: "22:00",
    geometry: { type: "Point", coordinates: [72.8642, 21.2400] }
  }
];
